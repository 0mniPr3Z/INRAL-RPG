...
Window_GameEnd.prototype = Object.create(Window_HorzCommand.prototype);
...
Window_GameEnd.prototype.makeCommandList = function() {
    this.addCommand(TextManager.vocab(1), 'french');
    this.addCommand(TextManager.vocab(2),  'english');
};