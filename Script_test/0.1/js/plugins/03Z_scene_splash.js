...
Scene_Splash.prototype.initScenario = function(){
	this._scenarStep = 0;
};
Scene_Splash.prototype.initFields = function(){
...
Scene_Splash.prototype.create = function() {
	...
	this._fields[4].bitmap = ImageManager.prelude("PressOk");
	this._fields[5].bitmap = ImageManager.prelude("Skip");
...
Scene_Splash.prototype.set_sequency							= function (index){
	//logo omniprez
	switch(index){
	
		case 0:
			this._fields[0].bitmap = ImageManager.prelude("Splash1");
		...
		case 1:
			...
			this._fields[1].bitmap = ImageManager.prelude("Splash2");
		...
		case 2:
			this._fields[0].bitmap = ImageManager.prelude("EndSplash");
		...
		case 3:
			...
			this._fields[2].bitmap = ImageManager.prelude("Cover_0");
		...
		case 4:
			...
			this._fields[1].bitmap = ImageManager.prelude("Cover_0");
		...
		case 5:
			SoundManager.playSystem('book');
			this._fields[1].bitmap = ImageManager.prelude("Livre_0");
			this._fields[1].opacityTarget = 255;
			this._fields[1].opacity = 255;
		...
		case 7:
			this._fields[2].bitmap = ImageManager.prelude("histoire_0");
			this._fields[2].opacity = 0;
			this._fields[2].opacityTarget = 255;
		...
		case 8:
			this._fields[2].opacityTarget = 0;
			this._fields[3].bitmap = ImageManager.prelude("histoire_1");
		...
		case 12:
			this.needToPressOk = true;
			this._fields[3].opacityTarget = 0;
			this._fields[2].bitmap = ImageManager.prelude("histoire_2");
			this._fields[2].opacity = 0;
			this._fields[2].opacityTarget = 255;
			this._fields[4].opacity =0;
		break;
		...
		case 13:
			this._fields[2].opacityTarget = 0;
			this._fields[3].bitmap = ImageManager.prelude("histoire_3");
			this._fields[3].opacity = 0;
			this._fields[3].opacityTarget = 255;
			this._fields[4].opacity =0;
		break;
		...
		case 17:
			this.needToPressOk = true;
			this._fields[3].opacityTarget = 0;
			this._fields[2].bitmap = ImageManager.prelude("histoire_4");
			this._fields[2].opacity = 0;
			this._fields[2].opacityTarget = 255;
			this._fields[4].opacity =0;
		break;
		...
		//debut formation
		case 18:
			this._fields[0].bitmap = ImageManager.prelude("formation_0");
			this._fields[2].opacityTarget = 0;
		...
		case 19:
			...
			this._fields[2].transitionSpeed = 5;
			this._fields[1].bitmap = ImageManager.prelude("formation_1");
			this._fields[2].bitmap = ImageManager.prelude("formation_text");
			this._fields[1].opacityTarget = 255;
			this._fields[2].opacityTarget = 255;
		break;
		
		case 20:
			this._fields[0].bitmap = ImageManager.prelude("formation_2");
			this._fields[1].opacityTarget = 0;
		break;
		
		case 21:
			this._fields[1].bitmap = ImageManager.prelude("formation_3");
			this._fields[1].opacityTarget = 255;
		break;
		
		case 22:
			this._fields[0].bitmap = ImageManager.prelude("formation_4");
			this._fields[1].opacityTarget = 0;
		break;
		
		case 23:
			this._fields[1].bitmap = ImageManager.prelude("formation_5");
			this._fields[1].opacityTarget = 255;
			this._fields[2].opacityTarget = 0;
		break;
		
		case 24:
			this._fields[2].bitmap = ImageManager.prelude("formation_text2");
			this._fields[0].bitmap = ImageManager.prelude("formation_6");
			this._fields[1].opacityTarget = 0;
		break;
		
		case 25:
			this._fields[2].opacityTarget = 255;
			this._fields[1].bitmap = ImageManager.prelude("formation_6");
			this._fields[1].opacityTarget = 255;
		break;
		
		case 26:
			this._fields[0].bitmap = ImageManager.prelude("formation_8");
			this._fields[1].opacityTarget = 0;
		break;
		
		case 27:
			this._fields[1].bitmap = ImageManager.prelude("formation_9");
			this._fields[1].opacityTarget = 255;
		break;
		
		case 28:
			this._fields[0].bitmap = ImageManager.prelude("formation_10");
			this._fields[1].opacityTarget = 0;
		break;
		case 29:
			this._fields[1].bitmap = ImageManager.prelude("formation_11");
			this._fields[1].opacityTarget = 255;
		break;
		
		case 30:
			this._fields[0].bitmap = ImageManager.prelude("formation_12");
			this._fields[1].opacityTarget = 0;
		break;
		...
		case 31:
			this.needToPressOk = true;
			this._fields[4].opacity =0;
			this._fields[1].bitmap = ImageManager.prelude("formation_13");
			this._fields[1].opacityTarget = 255;
		break;
		
		case 32:
			this._fields[0].bitmap = ImageManager.prelude("KaosBack_0");
			this._fields[1].opacityTarget = 0;
		...
		case 33:
			...
			this._fields[1].bitmap = ImageManager.prelude("KaosBack_1");
			this._fields[1].opacityTarget = 255;
		break;
...
Scene_Splash.prototype.is_updated_field_frame = function(i){
	...
	if(this._fields[i].frameWait > this._fields[i].frameDisplayed){
		...
		return false;
			...
			this._fields[i].bitmap = ImageManager.prelude(_frameName);
		return false;
	}
